    ...
    return (
      <main className="min-h-screen bg-slate-50 font-sans">
        ...
        <div className="container mx-auto max-w-4xl px-4 pt-48 pb-20 text-center">
           ...
           <h1 className="text-3xl font-bold_ text-slate-900 mb-4">Connect your wallet</h1>
    ...
    <main className="min-h-screen bg-slate-50 font-sans">
      ...
      <div className="container mx-auto max-w-6xl px-4 pt-32 pb-20">
        ...
        <div className="flex items-center gap-3 mb-10">
           ...
           <h1 className="text-4xl font-bold_ text-slate-900 tracking-tight">Capital Hub</h1>
        </div>
        ...
        <Tabs defaultValue="campaigns" className="w-full">
          <TabsList className="bg-transparent border-b border-slate-200 rounded-none w-full justify-start h-auto p-0 mb-8 no-scrollbar">
            <TabsTrigger value="campaigns" className="rounded-none border-b-2 border-transparent data-[state=active]:border-orange-500 data-[state=active]:text-orange-600 px-6 py-3 text-base font-bold_">
              My Campaigns
            </TabsTrigger>
            <TabsTrigger value="contributions" className="rounded-none border-b-2 border-transparent data-[state=active]:border-orange-500 data-[state=active]:text-orange-600 px-6 py-3 text-base font-bold_">
              My Contributions
            </TabsTrigger>
          </TabsList>
