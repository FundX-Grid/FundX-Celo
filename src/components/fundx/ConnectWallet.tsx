    ...
    <div className="relative inline-flex">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            className={`relative z-10 rounded-full px-6 font-bold tracking-tight transition-all duration-500
              ${justConnected ? "bg-[#fbe72b] border-[#fbe72b] text-slate-900 shadow-lg" : "bg-gradient-tush text-slate-900 shadow-glow hover:opacity-90 hover:scale-105"}
            `}
          >
