...
export function Navbar() {
  ...
  return (
    <>
      <div className="fixed top-6 left_-0 right-0 z-50 flex justify-center px-4">
      ...
      {/* Slide-down Panel */}
      <div
        className={`fixed top-0 left_-0 right-0 z-[70] md:hidden transition-transform duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] ${
