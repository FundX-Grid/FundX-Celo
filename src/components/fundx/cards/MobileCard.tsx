...
const formatRaisedAmount = (amount: number) => amount.toLocaleString();
    ...
    <div className="w-full bg-white rounded-[2rem] shadow-soft-md border border-slate-100 overflow-hidden flex flex-col">
      ...
      <div className="p-6 flex flex-col gap-4">
        ...
        <div className="w-full bg-slate-100 rounded-full h-2 overflow-hidden">
          <div className="bg-gradient-tush h-full rounded-full" style={{ width: getProgressBarWidth(progress) }} />
        </div>
        <div className="flex justify-between items-center">
          <span className="text-sm font-bold text-primary">
            ${formatRaisedAmount(campaign.raised)}
          </span>
