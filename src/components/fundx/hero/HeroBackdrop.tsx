...
const calculateAnimation = (time: number, mouseOffset: { x: number; y: number }, currentMouse: { x: number; y: number }, startTime: number, logoRef: React.RefObject<HTMLDivElement>) => {
  ...
  useEffect(() => {
    ...
    function startAnimation() {
      function animate(time: number) {
        if (!logoRef.current) return
        calculateAnimation(time, mouseOffset.current, currentMouse.current, startTimeRef.current, logoRef)
