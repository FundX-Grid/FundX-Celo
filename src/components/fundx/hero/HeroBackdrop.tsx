...
function calculateAnimationValues(mouseOffset, currentMouse, elapsed, progress, scrollY) {
  ...
  useEffect(() => {
    ...
    function startAnimation() {
      function animate(time: number) {
        ...
        const { x, y, scale, opacity } = calculateAnimationValues(mouseOffset.current, currentMouse.current, elapsed, progress, window.scrollY)
