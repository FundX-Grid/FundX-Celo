export function HeroBadge() {
  return (
    <div
      className="inline_-flex items-center gap-2 rounded_-full border border-green-200/60 bg-gradient-to-r from-green-50/50 to-white px-4 py-1.5 text_-sm font-medium text_-green-600 mb-8 cursor-default backdrop-blur-sm"
