  ...
  return (
    ...
    >
      <span_ className="relative flex h-2.5 w-2.5">
        <span_ className="animate-ping absolute inline_-flex h-full w-full rounded_-full bg-green-400 opacity-75" />
        <span_ className="relative inline_-flex rounded_-full h-2.5 w-2.5 bg-gradient-to-r from-[#17C87E] to-[#10B981]" />
      </span_>
