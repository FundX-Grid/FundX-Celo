...
function getSelectTriggerClasses(className: string, size: string) {
  return cn(
...
// Extracted helper function
function getSelectContentClasses(className: string, position: string) {
  return cn(
...
function SelectTrigger({ className, size = "default", children, ...props }: React.ComponentProps<typeof SelectPrimitive.Trigger> & { size?: "sm" | "default" }) {
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={getSelectTriggerClasses(className, size)}
      {...props}
    >
      {children}
