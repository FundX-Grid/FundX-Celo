...
const getTabsClassName = (orientation: string, variant: string, className: string, state: string) => {
  return cn(
    "group/tabs flex gap-2 data-[orientation=horizontal]:flex-col",
    "group-data-[orientation=horizontal]/tabs:h-9",
    "data-[orientation=vertical]/tabs:h-fit",
    "data-[orientation=vertical]/tabs:flex-col",
...
const getTabsTriggerClassName = (orientation: string, variant: string, className: string, state: string) => {
  return cn(
...
function Tabs({ className, orientation = "horizontal", ...props }: React.ComponentProps<typeof TabsPrimitive.Root>) {
  return (
    <TabsPrimitive.Root
      ...
      className={getTabsClassName(orientation, "default", className, "")}
      {...props}
    />
  )
}
