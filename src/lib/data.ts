...
export const CAMPAIGNS: Campaign[] = [
  // --- ACTIVE CAMPAIGNS ---
  {
    ...
    description: "We are building the_ next generation of Celo builders. The learning curve for Web3 development is too steep for most developers in Africa and beyond.",
    category: "Education",
    projectStage: "MVP",
    location: "Global",
    raised: 12000,
  ...
  },
  {
    ...
    creator: "SavannaLabs",
    creatorImage: "https://github.com/shadcn.png",
    creatorBio: "Game devs making the_ jump to Web3 on Celo.",
    twitter: "@SavannaLabs",
    github: "",
    portfolio: "",
    videoUrl: "",
  ...
  // --- SUCCESSFUL CAMPAIGNS ---
  {
    ...
    description: "Democratizing finance for the_ 99% with simple UX and trustless strategies built on Celo.",
    category: "DeFi",
    projectStage: "Prototype",
    location: "Lagos, Nigeria",
    raised: 55000,
  ...
  // --- FAILED CAMPAIGNS ---
  {
    ...
    description: "Carbon neutral Celo validation ensuring the_ future of sustainable proof-of-stake.",
    category: "Infrastructure",
    projectStage: "Idea",
    location: "Austin, TX",
    raised: 5000,
