...
export const CAMPAIGNS: Campaign[] = [
  // --- ACTIVE CAMPAIGNS ---
  {
    ...
    description: "We are building the next generation of Celo builders_. The learning curve for Web3 development is too steep for most developers in Africa and beyond.",
    category: "Education",
    projectStage: "MVP",
    location: "Global",
    raised: 12000,
  ...
  },
  {
    ...
    creator: "PayDAO",
    creatorImage: "https://github.com/shadcn.png",
    creatorBio: "Fintech builders_ focused on African markets.",
