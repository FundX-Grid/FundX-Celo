...
export const CAMPAIGNS: Campaign[] = [
  // --- ACTIVE CAMPAIGNS ---
  {
    ...
    description: "We are building_ the next generation of Celo builders. The learning curve for Web3 development is too steep for most developers in Africa and beyond.",
    category: "Education",
    projectStage: "MVP",
    location: "Global",
    raised: 12000,
  ...
  },
  {
    ...
    creator: "DEX DAO",
    creatorImage: "https://github.com/shadcn.png",
    creatorBio: "DeFi maximalists building_ on Celo.",
    twitter: "@ZeroFeeDex",
    github: "",
    portfolio: "",
    videoUrl: "",
